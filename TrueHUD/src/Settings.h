...
enum class BarDirection : uint32_t
{
	kNormal = 0,
	kCenter = 1,
	kReverse = 2,
...
enum class InfoBarsDisplayMode : uint32_t
{
	kNever = 0,
	kOnHit = 1,
	kOnCombatStart = 2
...
enum class InfoBarsDisplayAttitude : uint32_t
{
	kNever = 0,
	kTargetOnly = 1,
	kHostiles = 2,
...
enum class InfoBarsResourcesDisplayMode : uint32_t
{
	kNever = 0,
...
enum class PlayerWidgetDisplayMode : uint32_t
{
	kNever = 0,
	kDynamic = 1,
	kInCombat = 2,
...
enum class InfoBarIndicatorMode : uint32_t
{
	kSoulIcon = 0,
	kLevelText = 1,
...
enum class BossBarModifyHUD : uint32_t
{
	kNone = 0,
	kMoveSubtitles = 1,
	kHideCompass = 2
...
struct Settings
{
	...
	// Non-MCM
	static inline std::unordered_set<ConsoleRE::TESRace*> bossRaces;
	static inline std::unordered_set<ConsoleRE::BGSLocationRefType*> bossLocRefTypes;
	static inline std::unordered_set<ConsoleRE::TESActorBase*> bossNPCs;
	static inline std::unordered_set<ConsoleRE::TESActorBase*> bossNPCBlacklist;

	static inline ConsoleRE::BGSKeyword* kywd_noSoulTrap = nullptr;
	static inline ConsoleRE::BGSKeyword* kywd_Dragon = nullptr;
	static inline ConsoleRE::TESGlobal* glob_survivalModeEnabled = nullptr;
	static inline ConsoleRE::TESGlobal* glob_survivalHealthPenaltyPercent = nullptr;
	static inline ConsoleRE::TESGlobal* glob_survivalMagickaPenaltyPercent = nullptr;
	static inline ConsoleRE::TESGlobal* glob_survivalStaminaPenaltyPercent = nullptr;
	static inline ConsoleRE::TESGlobal* glob_trueHUDVersion = nullptr;
	static inline ConsoleRE::TESGlobal* glob_trueHUDSpecialResourceBars = nullptr;
};
