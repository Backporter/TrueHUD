...
namespace Scaleform
{
	...
	void PlayerWidget::FlashActorValue(ConsoleRE::ActorValue a_actorValue, bool a_bLong)
	{
	...
	void PlayerWidget::RefreshColors()
	{
		...
		ConsoleRE::GFxValue args[20];
		args[0].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kHealth, ColorType::BarColor));
		args[1].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kHealth, ColorType::PhantomColor));
		args[2].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kHealth, ColorType::BackgroundColor));
		args[3].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kHealth, ColorType::PenaltyColor));
		args[4].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kHealth, ColorType::FlashColor));
		args[5].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kMagicka, ColorType::BarColor));
		args[6].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kMagicka, ColorType::PhantomColor));
		args[7].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kMagicka, ColorType::BackgroundColor));
		args[8].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kMagicka, ColorType::PenaltyColor));
		args[9].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kMagicka, ColorType::FlashColor));
		args[10].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kStamina, ColorType::BarColor));
		args[11].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kStamina, ColorType::PhantomColor));
		args[12].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kStamina, ColorType::BackgroundColor));
		args[13].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kStamina, ColorType::PenaltyColor));
		args[14].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kStamina, ColorType::FlashColor));
	...
	void PlayerWidget::LoadConfig()
	{
		...
		args[34].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kHealth, ColorType::BarColor));
		args[35].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kHealth, ColorType::PhantomColor));
		args[36].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kHealth, ColorType::BackgroundColor));
		args[37].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kHealth, ColorType::PenaltyColor));
		args[38].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kHealth, ColorType::FlashColor));
		args[39].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kMagicka, ColorType::BarColor));
		args[40].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kMagicka, ColorType::PhantomColor));
		args[41].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kMagicka, ColorType::BackgroundColor));
		args[42].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kMagicka, ColorType::PenaltyColor));
		args[43].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kMagicka, ColorType::FlashColor));
		args[44].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kStamina, ColorType::BarColor));
		args[45].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kStamina, ColorType::PhantomColor));
		args[46].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kStamina, ColorType::BackgroundColor));
		args[47].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kStamina, ColorType::PenaltyColor));
		args[48].SetNumber(hudMenu->GetBarColor(playerHandle, ConsoleRE::ActorValue::kStamina, ColorType::FlashColor));
	...
	void PlayerWidget::UpdateInfo()
	{
		...
		permanentHealth = actorValueOwner->GetPermanentActorValue(ConsoleRE::ActorValue::kHealth);
		temporaryHealth = playerCharacter->GetActorValueModifier(ConsoleRE::ACTOR_VALUE_MODIFIER::kTemporary, ConsoleRE::ActorValue::kHealth);
		maxHealth = permanentHealth + temporaryHealth;
		maxHealth /= (1.f - _healthPenaltyPct);
		if (playerCharacter->IsDead()) {
			health = 0;
		} else {
			health = actorValueOwner->GetActorValue(ConsoleRE::ActorValue::kHealth);
		}

		permanentMagicka = actorValueOwner->GetPermanentActorValue(ConsoleRE::ActorValue::kMagicka);
		temporaryMagicka = playerCharacter->GetActorValueModifier(ConsoleRE::ACTOR_VALUE_MODIFIER::kTemporary, ConsoleRE::ActorValue::kMagicka);
		maxMagicka = permanentMagicka + temporaryMagicka;
		maxMagicka /= (1.f - _magickaPenaltyPct);
		magicka = actorValueOwner->GetActorValue(ConsoleRE::ActorValue::kMagicka);
		...
		if (Settings::bPlayerWidgetDisplayMountStamina && playerCharacter->GetMount(mount)) {
			...
			permanentStamina = mountActorValueOwner->GetPermanentActorValue(ConsoleRE::ActorValue::kStamina);
			temporaryStamina = mount->GetActorValueModifier(ConsoleRE::ACTOR_VALUE_MODIFIER::kTemporary, ConsoleRE::ActorValue::kStamina);
			maxStamina = permanentStamina + temporaryStamina;
			stamina = mountActorValueOwner->GetActorValue(ConsoleRE::ActorValue::kStamina);
			bIsInMountMode = true;
		} else {
			permanentStamina = actorValueOwner->GetPermanentActorValue(ConsoleRE::ActorValue::kStamina);
			temporaryStamina = playerCharacter->GetActorValueModifier(ConsoleRE::ACTOR_VALUE_MODIFIER::kTemporary, ConsoleRE::ActorValue::kStamina);
			maxStamina = permanentStamina + temporaryStamina;
			maxStamina /= (1.f - _staminaPenaltyPct);
			stamina = actorValueOwner->GetActorValue(ConsoleRE::ActorValue::kStamina);
			bIsInMountMode = false;
		}

		bool bIsInCombat = playerCharacter->IsInCombat();

		ConsoleRE::GFxValue args[12];
		...
		if (hudHandler && hudHandler->bSpecialFunctionsProvided && hudHandler->bDisplaySpecialForPlayer) {
			ConsoleRE::GFxValue specialArgs[3];
	...
	{
		ConsoleRE::GFxValue penaltyArgs[4];
